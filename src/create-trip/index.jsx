  ...
  return (
    <div className="px-5 mt-12 sm:px-10 md:px-32 lg:px-56 xl:px-72">
      ...
      <div className="mt-20 flex flex-col gap-10 ">
        <div className="mb-5">
          <label className="text-xl mb-3 font-medium">Destination</label>
        ...
        <div className="mb-5">
          <label className="text-xl font-medium">Number of Days</label>
          <Input
            placeholder={"Ex.3"}
            type="number"
            min="1"
        ...
        <div>
          <label className="text-xl my-3 font-medium">Budget</label>
          <p>
